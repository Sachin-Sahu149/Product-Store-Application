...
function SuccessToast({ bg, textColor, textSize, info, isVisible, setisVisible }) {
    ...
    return (
        <div
            ...
            `}>
            <div className='p-2 rounded bg-green-700 text-gray-300  '>
                <MdAddTask size={20} />
            </div>
            <p className={`max-w-52  p-1 ${textColor} ${textSize} `}>{info.success} </p>
